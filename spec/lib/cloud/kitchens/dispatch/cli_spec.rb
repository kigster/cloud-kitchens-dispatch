...
RSpec.describe Cloud::Kitchens::Dispatch::CLI do
  let(:options) { [] }
  ...
  shared_examples_for "a version command" do
    it "prints version" do
      result = -> { cli }
      pattern = /#{Regexp.escape Cloud::Kitchens::Dispatch::Identity::VERSION_LABEL}\n/
  ...
  shared_examples_for "a help command" do
    it "prints usage" do
      result = -> { cli }
      pattern = /#{Regexp.escape Cloud::Kitchens::Dispatch::Identity::VERSION_LABEL}\scommands:\n/
